...
dotnet build -p:Configuration=Release -p:Platform=AnyCPU FSharp.FlashCap/FSharp.FlashCap.csproj
...
dotnet pack -p:Configuration=Release -p:Platform=AnyCPU -o artifacts FSharp.FlashCap/FSharp.FlashCap.csproj
